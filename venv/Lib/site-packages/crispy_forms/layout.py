        ...
        for i, layout_object in enumerate(self.fields):
            if isinstance(layout_object, LayoutClasses):
                if str_class:
                    ...
                    pointers.append(
                        Pointer(index + [i], layout_object.__class__.__name__.lower())
                    )
...
class BaseInput(TemplateNameMixin):
    ...
    **kwargs : dict, optional
    ...
    def __init__(
        self, name, value, *, css_id=None, css_class=None, template=None, **kwargs
    ):
        self.name = name
        self.value = value
        if css_id:
...
class Fieldset(LayoutObject):
    ...
    **kwargs : dict, optional
    ...
    def __init__(
        self, legend, *fields, css_class=None, css_id=None, template=None, **kwargs
    ):
        self.fields = list(fields)
        self.legend = legend
        self.css_class = css_class
